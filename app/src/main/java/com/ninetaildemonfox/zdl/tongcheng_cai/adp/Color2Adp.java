...
public class Color2Adp extends BaseQuickAdapter<WFootallBean.DataBeanXXX.ListBean.PlayValueBean.VictoryBean.DataBean, BaseViewHolder> {

    public Color2Adp(int item_color_list_adp) {
        super(item_color_list_adp);
    }

    @Override
    protected void convert(BaseViewHolder helper, WFootallBean.DataBeanXXX.ListBean.PlayValueBean.VictoryBean.DataBean item) {
