...
public class MyCaiTouZhuAdp extends BaseQuickAdapter<Map<String, String>, BaseViewHolder> {
    ...
    public MyCaiTouZhuAdp(int layoutResId, @Nullable List<Map<String, String>> data) {
        super(layoutResId, data);
    }

    public MyCaiTouZhuAdp(int item_touzhu) {
        super(item_touzhu);
    }
