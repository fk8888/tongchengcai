...
public class Color1Adp extends BaseQuickAdapter<Map<String, String>, BaseViewHolder> {

    public Color1Adp(int item_color_list_adp) {
...
//        TextView text_is_push = helper.itemView.findViewById(R.id.text_is_push);
        ...
        if (item.get("is_true").equals("true")) {
