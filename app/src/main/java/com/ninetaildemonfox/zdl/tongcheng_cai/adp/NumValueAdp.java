...
public class NumValueAdp extends BaseQuickAdapter<WFootallBean.DataBeanXXX.ListBean.PlayValueBean.NumberValueBean, BaseViewHolder> {

    public NumValueAdp(int item_color_list_adp) {
        super(item_color_list_adp);
    }

    @Override
    protected void convert(BaseViewHolder helper, WFootallBean.DataBeanXXX.ListBean.PlayValueBean.NumberValueBean item) {
