...
public class HalfNumAdp extends BaseQuickAdapter<WFootallBean.DataBeanXXX.ListBean.PlayValueBean.HalfBean, BaseViewHolder> {

    public HalfNumAdp(int item_color_list_adp) {
        super(item_color_list_adp);
    }

    @Override
    protected void convert(BaseViewHolder helper, WFootallBean.DataBeanXXX.ListBean.PlayValueBean.HalfBean item) {
